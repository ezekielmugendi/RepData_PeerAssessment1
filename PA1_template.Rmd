...
```{r}
setwd("C:/Users/ezeki/Documents/wd")
if(!file.exists("wd")) dir.create("wd")
url <- "https://d396qusza40orc.cloudfront.net/repdata%2Fdata%2Factivity.zip"
download.file(url, destfile=("./wd"))
unzip("./wd/Factivity.zip", exdir="./wd")
activity <- read.csv("./wd/activity.csv")
```
...
plot a time series
```{r}
plot(x = interval$interval, y = interval$steps, type = "l", main = "Time Series Plot of the 5-Minute Interval depicting the average daily activity pattern", xlab = "5-Minute Interval", ylab = "Average Number of Total Steps Taken")
```
...
```{r}
library(lattice)
xyplot(steps ~ interval | typeofday, newinterval, type = "l", layout = c(1,2), main = "Time series plot of the 5-minute interval (x-axis) and the average number of steps taken, averaged across all weekday days or weekend days", xlab = "5-Minute Interval", ylab = "Average Number of Steps Taken")
```
